  ...
  >
    ...
    >
      ...
      <template #bottom>
		...
		<IndexArchive v-if="$pagination" :sidebar-items="sidebarItems" />
    <Archive v-else :sidebar-items="sidebarItems" />
  </div>
</template>
...
import IndexArchive from '@theme/components/IndexArchive.vue'
